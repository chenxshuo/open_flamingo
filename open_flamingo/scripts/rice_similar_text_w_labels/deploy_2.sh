# nohup bash open_flamingo/scripts/rice_similar_text_w_labels/deploy_2.sh > ./logs/rice_similar_text_w_labels/deploy.text  2>&1 &
...
#
bash open_flamingo/scripts/rice_similar_text_w_labels/run_eval_9B_vqav2.sh 4 26000 16 &> ./logs/rice_similar_text_w_labels/out-rice-img-9B-vqav2-shot-4.text
bash open_flamingo/scripts/rice_similar_text_w_labels/run_eval_9B_vqav2.sh 8 26001 8 &> ./logs/rice_similar_text_w_labels/out-rice-img-9B-vqav2-shot-8.text
