# nohup bash open_flamingo/scripts/collect_attn_weights/deploy_2.sh > ./logs/out_collect_attn_weights-4B_deploy_2.sh 2>&1 &
...
bash open_flamingo/scripts/collect_attn_weights/run_eval_9B_gqa.sh  4 26002 7 False False &> ./logs/out-collect_attn_weights-9B-gqa-random-shot-4.text
bash open_flamingo/scripts/collect_attn_weights/run_eval_9B_gqa.sh  4 26002 7 True False &> ./logs/out-collect_attn_weights-9B-gqa-no_images-shot-4.text
bash open_flamingo/scripts/collect_attn_weights/run_eval_9B_gqa.sh  4 26002 7 False True &> ./logs/out-collect_attn_weights-9B-gqa-no_query_image-shot-4.text
