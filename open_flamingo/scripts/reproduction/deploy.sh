...
bash open_flamingo/scripts/reproduction/run_eval_9B_textvqa.sh 32 26003 32 &> out-reproduce-9B-textvqa-shot-32.text
...
bash open_flamingo/scripts/reproduction/run_eval_9B_vizwiz.sh 32 26004 32 &> out-reproduce-9B-vizwiz-shot-32.text
...
bash open_flamingo/scripts/reproduction/run_eval_9B_flickr30k.sh 32 26004 32 &> out-reproduce-9B-flickr30k-shot-32.text
echo "Done with flickr30k shot 16"
...
bash open_flamingo/scripts/reproduction/run_eval_9B_coco.sh 32 26004 32 &> out-reproduce-9B-coco-shot-32.text
echo "Done with coco shot 32"

#bash open_flamingo/scripts/reproduction/run_eval_9B_hatefulmemes.sh 0 26000 64 &> out-reproduce-9B-coco-shot-0.text
bash open_flamingo/scripts/reproduction/run_eval_9B_hatefulmemes.sh 4 26001 64 &> out-reproduce-9B-hatefulmemes-shot-4.text
echo "Done with hatefulmemes shot 4"
bash open_flamingo/scripts/reproduction/run_eval_9B_hatefulmemes.sh 8 26002 64 &> out-reproduce-9B-hatefulmemes-shot-8.text
echo "Done with hatefulmemes shot 8"
bash open_flamingo/scripts/reproduction/run_eval_9B_hatefulmemes.sh 16 26003 32 &> out-reproduce-9B-hatefulmemes-shot-16.text
echo "Done with hatefulmemes shot 16"
bash open_flamingo/scripts/reproduction/run_eval_9B_hatefulmemes.sh 32 26004 32 &> out-reproduce-9B-hatefulmemes-shot-32.text
