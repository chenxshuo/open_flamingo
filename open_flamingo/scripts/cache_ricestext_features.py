...
def main():
    ...
    if args.eval_flickr30:
        ...
        torch.save(
            ...
            os.path.join(args.output_dir, "flickr30_ricestext.pkl"),
        )
    ...
    if args.eval_coco:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "coco_ricestext.pkl"),
        )
    ...
    if args.eval_ok_vqa:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "ok_vqa_ricestext.pkl"),
        )
    ...
    if args.eval_gqa:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "gqa_ricestext.pkl"),
        )
    ...
    if args.eval_vizwiz:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "vizwiz_ricestext.pkl"),
        )
    ...
    if args.eval_vqav2:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "vqav2_ricestext.pkl"),
        )
    ...
    if args.eval_textvqa:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "textvqa_ricestext.pkl"),
        )
    ...
    if args.eval_hateful_memes:
        ...
        torch.save(
            rices_dataset.features,
            os.path.join(args.output_dir, "hateful_memes_ricestext.pkl"),
        )
