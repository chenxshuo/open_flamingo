# nohup bash open_flamingo/scripts/rice_img/every_nth/deploy.sh &> ./logs/deploy_rices_every_nth.log 2>&1 &

#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 4 26000 32 random &> ./logs/eval_coco_rices_every_nth_shot_4_visual_random.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 4 26001 32 no_images &> ./logs/eval_coco_rices_every_nth_shot_4_visual_no_images.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 8 26002 32 random &> ./logs/eval_coco_rices_every_nth_shot_8_visual_random.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 8 26003 32 no_images &> ./logs/eval_coco_rices_every_nth_shot_8_visual_no_images.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 16 26004 8 random &> ./logs/eval_coco_rices_every_nth_shot_16_visual_random.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 16 26005 8 no_images &> ./logs/eval_coco_rices_every_nth_shot_16_visual_no_images.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 32 26006 8 random &> ./logs/eval_coco_rices_every_nth_shot_32_visual_random.log
#bash open_flamingo/scripts/rice_img/every_nth/run_eval_9B_coco.sh 32 26007 8 no_images &> ./logs/eval_coco_rices_every_nth_shot_32_visual_no_images.log
#
