# nohup bash open_flamingo/scripts/rice_img/every_nth/deploy_4.sh &> ./logs/deploy_4_rices_every_nth.log 2>&1 &
...
#bash open_flamingo/scripts/rice_img/every_nth/run_ev3al_9B_vqav2.sh 32 26007 8 no_images &> ./logs/eval_vqav2_rices_every_nth_shot_32_visual_no_images.log
#
