...
# gqa
#
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_outer_label_as_labels 26000 4 64 &> ./logs/eval_gqa_language_random_outer_label_as_labels_shot4.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_outer_label_as_labels 26001 8 64 &> ./logs/eval_gqa_language_random_outer_label_as_labels_shot8.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_outer_label_as_labels 26002 16 32 &> ./logs/eval_gqa_language_random_outer_label_as_labels_shot16.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_outer_label_as_labels 26003 32 16 &> ./logs/eval_gqa_language_random_outer_label_as_labels_shot32.log
#
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_label_for_same_question_as_labels 26000 4 64 &> ./logs/eval_gqa_language_random_label_for_same_question_as_labels_shot4.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_label_for_same_question_as_labels 26001 8 64 &> ./logs/eval_gqa_language_random_label_for_same_question_as_labels_shot8.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_label_for_same_question_as_labels 26002 16 32 &> ./logs/eval_gqa_language_random_label_for_same_question_as_labels_shot16.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_label_for_same_question_as_labels 26003 32 16 &> ./logs/eval_gqa_language_random_label_for_same_question_as_labels_shot32.log
#
...
#
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_question_inputs 26004 4 64 &> ./logs/eval_gqa_language_random_question_inputs_shot4.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_question_inputs 26005 8 64 &> ./logs/eval_gqa_language_random_question_inputs_shot8.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_question_inputs 26006 16 8 &> ./logs/eval_gqa_language_random_question_inputs_shot16.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh random_question_inputs 26007 32 8 &> ./logs/eval_gqa_language_random_question_inputs_shot32.log
#
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh no_labels 26004 4 64 &> ./logs/eval_gqa_language_no_labels_shot4.log
#bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh no_labels 26005 8 64 &> ./logs/eval_gqa_language_no_labels_shot8.log
...
bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh only_labels 26006 16 8 &> ./logs/eval_gqa_language_only_labels_shot16.log
bash open_flamingo/scripts/language_understand/run_eval_9B_gqa.sh only_labels 26007 32 8 &> ./logs/eval_gqa_language_only_labels_shot32.log
