...
bash open_flamingo/scripts/no_images/run_eval_9B_gqa.sh  4 26001 64 no_images &> ./out-no-images-9B-gqa-no_images-shot-4.text
bash open_flamingo/scripts/no_images/run_eval_9B_gqa.sh  8 26002 32 no_images &> ./out-no-images-9B-gqa-no_images-shot-8.text
bash open_flamingo/scripts/no_images/run_eval_9B_gqa.sh  16 26003 16 no_images &> ./out-no-images-9B-gqa-no_images-shot-16.text
bash open_flamingo/scripts/no_images/run_eval_9B_gqa.sh  32 26004 8 no_images &> ./out-no-images-9B-gqa-no_images-shot-32.text
