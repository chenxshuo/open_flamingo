...
for i in range(BS):
    print(f"Forward result for batch {i}: {forward_result[i]}")
    print(f"Forward result shape for batch {i}: {forward_result[i].shape}")
# print("Generated text: ", tokenizer.decode(generated_text[0]))

# logger.info(f"Model Structure OF {MODEL}")
