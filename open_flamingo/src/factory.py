...
from .prompt_learning import FlamingoSoftPrompt
...
def create_model_and_transforms_w_prompt(
        clip_vision_encoder_path: str,
        clip_vision_encoder_pretrained: str,
        lang_encoder_path: str,
        tokenizer_path: str,
        ...
        robust_prompting_at_last=False,
        guide_attention=False,
        attention_amplify_factor =1,
        guide_head_index = [],
    ...
    model = FlamingoSoftPrompt(
        ...
        robust_prompting_at_last=robust_prompting_at_last,
        guide_attention=guide_attention,
        attention_amplify_factor=attention_amplify_factor,
    ...
    model.soft_prompt_media.requires_grad_(True)
    model.soft_prompt_text.requires_grad_(True)
