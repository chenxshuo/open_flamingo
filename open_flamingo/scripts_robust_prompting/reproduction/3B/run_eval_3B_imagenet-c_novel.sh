...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ROOT="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-C/novel-8-classes-imagenet-C-severity-5"
    IMAGENET_VAL_ANNO="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-C/imagenet_c_novel_classes_val.json"
    ...
    IMAGENET_VAL_ROOT="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-C/novel-8-classes-imagenet-C-severity-5"
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-C/imagenet_c_novel_classes_val.json"
else
