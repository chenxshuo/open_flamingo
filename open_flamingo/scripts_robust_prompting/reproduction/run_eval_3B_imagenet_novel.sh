...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ROOT="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet/subset-32-classes/val"
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet/imagenet_annotation_val_${NUMBER_CLASS}_classes.json"
else
