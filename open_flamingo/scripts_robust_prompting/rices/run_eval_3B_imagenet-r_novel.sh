...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ROOT="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-R/imagenet-r"
    IMAGENET_VAL_ANNO="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-R/imagenet_r_annotation_val_${NUMBER_CLASS}_classes.json"
    ...
    IMAGENET_VAL_ROOT="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-R/imagenet-r"
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-R/imagenet_r_annotation_val_${NUMBER_CLASS}_classes.json"
else
