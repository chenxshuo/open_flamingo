...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ROOT="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-V2/imagenetv2-top-images-format-val"
    IMAGENET_VAL_ANNO="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-V2/imagenet_v2_annotation_val_${NUMBER_CLASS}_classes.json"
    ...
    IMAGENET_VAL_ROOT="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-V2/imagenetv2-top-images-format-val"
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-V2/imagenet_v2_annotation_val_${NUMBER_CLASS}_classes.json"
else
