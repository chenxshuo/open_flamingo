...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ANNO="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet-A/imagenet_a_novel_classes_val.json"
    ...
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet-A/imagenet_a_novel_classes_val.json"
else
