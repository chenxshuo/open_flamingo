...
if [ $USER_NAME == "di93zun" ]; then
    ...
    IMAGENET_VAL_ROOT="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet/novel-8-classes/val"
    IMAGENET_VAL_ANNO="/dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/datasets/imagenet/novel-8-classes/imagenet1k_novel_classes_val.json"
    ...
    IMAGENET_VAL_ROOT="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet/novel-8-classes/val"
    IMAGENET_VAL_ANNO="/home/atuin/b207dd/b207dd13/in-context/dataset/imagenet/imagenet/novel-8-classes/imagenet1k_novel_classes_val.json"
else
