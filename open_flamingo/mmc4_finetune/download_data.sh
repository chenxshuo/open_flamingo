...
# download the smaller "core fewer faces" documents
# copy paste from https://github.com/allenai/mmc4/blob/main/scripts/fewer_faces_corev3.sh
# usage: $ bash download_data.sh /dss/dssmcmlfs01/pn34sa/pn34sa-dss-0000/robustness/in-context-open-flamingo/mmc4
