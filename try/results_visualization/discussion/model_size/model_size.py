...
sns.set(font="times new roman", style="ticks", palette=[COLOR_2, COLOR_3, COLOR_4, COLOR_5, COLOR_5], rc=d)
...
# create subplots
fig, ((shot4, shot8), (shot16, shot32)) = plt.subplots(2, 2, figsize=(8, 4.5), constrained_layout=True)
...
# fig.suptitle(f"OpenFlamingo on GQA", fontsize=18, fontfamily="times new roman")
plt.show()

# save the plot
fig.savefig(f"ablation-size-{MODEL}.pdf", dpi=500)